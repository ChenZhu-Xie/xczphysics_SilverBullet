...
## 为什么 [[Library/xczphysics/CONFIG/Add_Fields_for_Obj/Last_Opened-Page]] 中的 lastVisit 甚至重开 SB 就没了，生命周期 甚至 短于 indexDB
...
问题在这：每次加载 SB 后，[[Library/xczphysics/CONFIG/Add_Fields_for_Obj/Last_Opened-Page]] 中的 
```space-lua
