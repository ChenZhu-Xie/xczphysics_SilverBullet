...
4. press `enter`
5. below the HEADER `Repositories`
6. click commandButton `Library: Add Repository`
7. input URL `https://github.com/ChenZhu-Xie/xczphysics_SilverBullet/blob/main/Repositories/xczphysics.md`
