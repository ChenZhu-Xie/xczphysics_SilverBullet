...
1. [click history](https://community.silverbullet.md/t/click-history/3569/10?u=chenzhu-xie) #community #silverbullet
 ...
 - ==不等于== [[CONFIG/KeyBinding/Update#Page Picker|Page Picker]]
    ...
    - 不是 [[CONFIG/Add_Fields_for_Obj/Last_Opened-Page/Query#3rd try|lastOpened]] 的 降序
    - 不是 [[CONFIG/Query/lastModified]] 的 降序
    - 不是 [[CONFIG/Mouse/History_+_Center#Click History|Click History]] 的 降序
