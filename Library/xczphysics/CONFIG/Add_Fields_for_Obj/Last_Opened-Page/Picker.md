...
1. [click history](https://community.silverbullet.md/t/click-history/3569/10?u=chenzhu-xie) #community #silverbullet
 ...
 - ==不等于== [[Library/xczphysics/CONFIG/KeyBinding/Update#Page Picker|Page Picker]]
    - 到现在为止，我也没搞清楚 [[Library/xczphysics/CONFIG/KeyBinding/Update#Page Picker|Page Picker]] 的排序规则：
    - 既不是 [[CONFIG/Add_Fields_for_Obj/Last_Opened-Page/Query#3rd try|lastOpened]] 的 降序
    - 也不是 [[CONFIG/Query/lastModified]] 的 降序
    - 也不是 [[Library/xczphysics/CONFIG/Mouse/History_+_Center#Click History|Click History]] 的 降序...
