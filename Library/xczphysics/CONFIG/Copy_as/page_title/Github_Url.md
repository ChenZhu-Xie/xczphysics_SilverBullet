---
author: Chenzhu-Xie
name: Library/xczphysics/CONFIG/Copy_as/page_title/Github_Url
tags: meta/library
...
1. 使用了 [[CONFIG/Plug_dev/Github_Url]] 的 `function: encode_url`
   - [[Library/xczphysics/CONFIG/Copy_as/Cursor_Link]] 和 [[Library/xczphysics/CONFIG/Copy_as/page_title/Page_Link]] 也用了
