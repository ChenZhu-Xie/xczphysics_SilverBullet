...
command.define {
  ...
  run = function()
    space.writeDocument("Library/LinkFloater.js", jsCode)
...
event.listen {
  ...
  run = function()
    ...
    if editor.isClient() then
        js.import("/.fs/Library/LinkFloater.js").enable()
    end
  end
}
...
local function pushBacklinks()
    ...
    js.import("/.fs/Library/LinkFloater.js").updateBacklinks(results)
end
