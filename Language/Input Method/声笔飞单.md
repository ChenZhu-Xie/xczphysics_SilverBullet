...
- 打常规成字部首时，#SPBB=全qu码meu字zga 中的 P（部首）为
  - 横 h = e 一
  - 竖 s = i 丨
  - 撇 p = u 丿
  - 点 d = o 丶
  - 折 z = a 乛
#### 声st笔b'
- 打常规成字部首中的声笔字时，优先沿用 #SB=声st笔b'字zga 的规则
#### 变bw形xp
>>>>>>  变bw #SP=二ve简jpo字zga 形xp #SP=二ve简jpo字zga
- #SPBB=全qu码meu字zga 中的 P 换用「日土母己」对应的「vtmj」
  - 打成字部首中的变形字「曰士毋已」时
  - 
...
[[Language/Input Method/声笔飞单### 全qu码meu字zga = 用 SPBB 表示]]
