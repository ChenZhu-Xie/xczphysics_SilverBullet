...
- [[Logseq]] 的 live query 可以自动刷新（且应该是事件触发的）
  ...
  - 似乎还有个 preview 的 db 版本：https://test.logseq.com/
    ...
    - 这意味着 github 同步 md 文件没有作用了，只能同步 SQLite 文件，但由于 SQLite 加密了（类似 思源）同步过去 也没有用 [will logseq sync be open source](https://discuss.logseq.com/t/will-logseq-sync-be-open-source/31903/13) #discuss #logseq
